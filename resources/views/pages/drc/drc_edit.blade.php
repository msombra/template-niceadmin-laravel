<x-layout pagetitle="Editar Acordo" button-top-right="Exibir Histórico">
    ...
    <x-form.form-layout action="drc.update" :data-id="$acordo->id" route-list="drc.list">
        ...
        {{-- Localizador (NPJ) --}}
        <x-form.input :value="$acordo->localizador_npj" label="Localizador (NPJ)" name="localizador_npj" type="text" max="11" required numeric-input />

        {{-- Adverso Principal --}}
        <x-form.input :value="$acordo->adverso_principal" label="Adverso Principal" name="adverso_principal" type="text" required col="5" />

        {{-- CPF/CNPJ --}}
        <x-form.input :value="$acordo->cpf_cnpj" label="CPF/CNPJ" name="cpf_cnpj" type="text" max="18" col="3" required />

        {{-- MCI --}}
        <x-form.input :value="$acordo->mci" label="MCI" name="mci" type="text" max="9" required numeric-input />
        ...
        {{-- Rastreamento --}}
        <x-form.input :value="$acordo->rastreamento" label="Rastreamento" name="rastreamento" type="text" max="14" required numeric-input />

        {{-- Documentos Classificados --}}
        <x-form.select label="Docs. Classificados" :name="$name = 'documentos_classificados'" required :type-bool="$acordo->documentos_classificados" />
        ...
        {{-- Valor Recuperação --}}
        <x-form.input-money :value="$acordo->valor_recuperacao" label="Valor Recuperação" name="valor_recuperacao" required />
